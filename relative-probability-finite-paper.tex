...
We set \(0^{-1} := \infty\) and \(\infty^{-1} := 0\), even though their product is indeterminate within \(\mathbb{M}\) and they do quite act as a multiplicative inverses of each other.
