...
In this case, the probability triangle has been truncated. For higher order simplices, this appears to become exceedingly unwieldy unless some simplifying trick is developed. If it is successfully done, then a new, cleaner, representation for memebers of \(\text{RPF}(K)\) falls into place.
